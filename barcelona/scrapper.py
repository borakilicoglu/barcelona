...
class Scraper:
    def __init__(self):
        ...
        response = self.session.get(
            url="https://www.transfermarkt.com/barcelona/startseite/verein/131/saison_id/2023"
        )
    ...
    @property
    def matches(self):
        return self.session.get("https://www.transfermarkt.com/ceapi/nextMatches/team/131").json()

    @property
    def rumors(self):
        return self.session.get("https://www.transfermarkt.com/ceapi/rumors/team/131").json()["rumors"]
